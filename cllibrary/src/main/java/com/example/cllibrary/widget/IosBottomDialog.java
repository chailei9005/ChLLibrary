package com.example.cllibrary.widget;
...
import com.example.cllibrary.R;
import com.example.cllibrary.utils.UIUtils;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by chailei on 2016/11/8.
 */
        ...
        public IosBottomDialog create() {
            ...
            if (p.options.size() == 0) {
                ...
                for (int i = 0; i < p.options.size(); i++) {
                    ...
                    optionText.setPadding(UIUtils.dip2px(context,20), UIUtils.dip2px(context,20), UIUtils.dip2px(context,20), UIUtils.dip2px(context,20));
...
class Paraments {
    ...
    public static final int optionTextSize = 20;
    public String title;
